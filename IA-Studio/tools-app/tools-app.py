    ...
    try:
        ...
        while True:
            ...
            response = openai_client.responses.create(
                ...
                oferecidos pela Agência de Viagens da Margie.
                Responda a perguntas sobre os serviços oferecidos 
                pela Agência de Viagens da Margie usando os folhetos de viagem fornecidos.
